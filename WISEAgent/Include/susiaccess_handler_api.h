...
typedef AGENT_SEND_STATUS  (*HandlerSendCustCbf) ( HANDLE const handler, int enum_act, void const * const topic, 
											  void const * const requestData, unsigned int const requestLen, 
											  void *pRev1, void* pRev2 ); 

typedef void (*HandlerCustMessageRecvCbf)(char * const topic, void* const data, const size_t datalen, void *pRev1, void* pRev2);

typedef AGENT_SEND_STATUS  (*HandlerSubscribeCustCbf) ( void const * const topic, HandlerCustMessageRecvCbf recvCbf); 
